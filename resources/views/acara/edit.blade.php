...
.form-control { width: 100%; padding: 11px 14px; border: 2px solid #d4dbe5; border-radius: 10px; font-size: 14px; font-family: 'Inter', sans-serif; color: #12283a; background: #eef3f9; outline: none; transition: border .15s; }
...
.btn-submit { flex: 1; background: #12283a; color: white; border: none; padding: 13px; border-radius: 12px; font-size: 14px; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; border: 1px solid #d4dbe5; transition: opacity .15s; }
.btn-submit:hover { opacity: .9; }
.btn-cancel { background: #eef3f9; color: #555; padding: 13px 24px; border-radius: 12px; font-size: 14px; font-weight: 700; text-decoration: none; display: flex; align-items: center; gap: 8px; border: 2px solid #d4dbe5; transition: border .15s; }
