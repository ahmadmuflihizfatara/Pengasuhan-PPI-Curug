...
.form-card-header {
    padding: 16px 22px; border-bottom: 1px solid #d4dbe5;
...
.form-hint { font-size: 11px; color: #6b7c93; margin-top: 4px; }

/* ── Checkbox Toggle ── */
.toggle-wrap {
    display:flex; align-items:center; gap:10px;
    padding:13px 14px; border:1.5px solid #d4dbe5; border-radius:10px;
...
.toggle-slider {
    width:38px; height:20px; background:#d4dbe5; border-radius:20px;
...
/* ── Image Upload ── */
.img-upload-area {
    border: 2px dashed #d4dbe5; border-radius: 12px;
...
.img-upload-area i   { font-size:28px; color:#d4dbe5; margin-bottom:8px; display:block; }
...
.kat-pill  {
    ...
    border:1.5px solid #d4dbe5; cursor:pointer; transition:all .15s;
                            ...
                            <div class="kat-pills" id="kat-pills">
                                @php
                                    $katConfig = [
                                        ...
                                        'informasi'  => ['label'=>'Informasi',  'icon'=>'fa-info-circle', 'bg'=>'#12283a', 'color'=>'#12283a'],
                                        'lainnya'    => ['label'=>'Lainnya',    'icon'=>'fa-newspaper',   'bg'=>'#12283a', 'color'=>'#12283a'],
                                    ];
