...
.admin-list-filter .search-input, .admin-list-filter .filter-input, .admin-list-filter .search-bar input, .admin-list-filter .form-control { width:100%; height:42px; padding:9px 12px 9px 34px; border:1.5px solid #edf0f7 !important; border-radius:10px !important; outline:0; color:#444; background:#fafbff !important; font:13px 'Inter',sans-serif; box-shadow:none !important; }
.admin-list-filter .filter-select, .admin-list-filter .form-select { height:42px; padding:9px 14px; border:1.5px solid #edf0f7 !important; border-radius:10px !important; outline:0; color:#444; background:#fafbff !important; font:13px 'Inter',sans-serif; cursor:pointer; box-shadow:none !important; }
.admin-list-filter .search-input:focus, .admin-list-filter .filter-input:focus, .admin-list-filter .search-bar input:focus, .admin-list-filter .filter-select:focus, .admin-list-filter .form-control:focus, .admin-list-filter .form-select:focus { border-color:#667eea; box-shadow:none; }
.admin-list-filter .btn-filter { height:38px; border:0 !important; border-radius:10px !important; padding:9px 20px; background:linear-gradient(135deg,#667eea,#764ba2) !important; color:#fff !important; font:700 13px 'Inter',sans-serif; display:inline-flex; align-items:center; gap:6px; cursor:pointer; white-space:nowrap; }
...
.admin-list-table .btn-edit { background:#eef0ff; color:#667eea; }
