...
.btn-process { background: #eef3f9; color: #12283a; border: 1px solid #d4dbe5; padding: 8px 18px; border-radius: 10px; font-size: 12px; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; }
.btn-process:hover { background: #d4dbe5; }
...
.field-label { font-size: 10px; font-weight: 700; color: #6b7c93; text-transform: uppercase; letter-spacing: .06em; margin-bottom: 6px; display: flex; align-items: center; gap: 5px; }
...
.timestamps { margin-top: 18px; padding-top: 14px; border-top: 1px solid #d4dbe5; display: flex; gap: 20px; }
.timestamps span { font-size: 11px; color: #6b7c93; display: flex; align-items: center; gap: 5px; }
...
.modal-btn-cancel { background:#eef3f9; color:#6b7c93; border:1px solid #d4dbe5; padding:10px 22px; border-radius:25px; font-size:13px; font-weight:700; cursor:pointer; }
.modal-btn-confirm-process { background:linear-gradient(135deg,#12283a,#0d9488); color:white; border:none; padding:10px 24px; border-radius:25px; font-size:13px; font-weight:800; cursor:pointer; }
    ...
    <div class="main-content">
        ...
        <div class="detail-card">
            ...
            <div class="detail-body">
                ...
                <div style="margin-top:16px; padding:16px 18px; background:{{ $reward->status === 'Disetujui' ? '#f0fff4' : ($reward->status === 'Ditolak' ? '#fff5f5' : '#eef3f9') }}; border-radius:12px; border-left:4px solid {{ $reward->status === 'Disetujui' ? '#38a169' : ($reward->status === 'Ditolak' ? '#e53e3e' : '#fdbb11') }};">
...
function openModal(status) {
    ...
    if (status === 'Diproses') {
        title.innerHTML = '<i class="fas fa-play" style="color:#12283a; margin-right:8px;"></i> Proses Reward';
