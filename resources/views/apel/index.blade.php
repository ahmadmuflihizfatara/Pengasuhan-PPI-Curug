...
.btn-primary {
    background:white; color:#12283a; border:none;
...
.btn-primary:hover { transform:translateY(-2px); box-shadow:0 8px 22px rgba(0,0,0,.18); color:#12283a; }
...
.text-block h3 { font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.06em; color:#6b7c93; margin:0 0 7px; display:flex; align-items:center; gap:6px; }
.text-block .isi { font-size:13.5px; color:#12283a; line-height:1.65; white-space:pre-line; background:#eef3f9; border-left:3px solid #fdbb11; border-radius:0 10px 10px 0; padding:13px 16px; }
.text-block .isi.kosong { color:#b9bfcc; font-style:italic; border-left-color:#d4dbe5; }

.detail-foot { border-top:1px solid #d4dbe5; padding:14px 26px; font-size:11.5px; color:#6b7c93; display:flex; justify-content:space-between; flex-wrap:wrap; gap:8px; }
...
.empty-state p { font-size:14px; color:#6b7c93; margin:0 0 18px; font-weight:600; }
.btn-solid {
