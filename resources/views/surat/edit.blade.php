...
.page-header { background: linear-gradient(135deg, #4f46e5 0%, #4338ca 100%); border-radius: 18px; padding: 28px 32px; color: white; margin-bottom: 24px; position: relative; overflow: hidden; }
...
.file-info { background: #eef0ff; border-radius: 8px; padding: 9px 14px; margin-bottom: 8px; font-size: 12px; color: #4f46e5; font-weight: 600; display: flex; align-items: center; gap: 8px; }
.file-info a { color: #4338ca; margin-left: auto; font-weight: 700; text-decoration: none; }

.btn-row { display: flex; gap: 12px; justify-content: flex-end; margin-top: 28px; padding-top: 20px; border-top: 1px solid #f0f2f7; }
.btn-submit { background: linear-gradient(135deg, #4f46e5, #4338ca); color: white; border: none; padding: 12px 30px; border-radius: 25px; font-size: 13px; font-weight: 800; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 4px 15px rgba(79,70,229,.4); transition: opacity .15s; }
