...
.btn-add { position: relative; z-index: 1; background: white; color: #12283a; padding: 11px 22px; border-radius: 25px; text-decoration: none; font-size: 13px; font-weight: 800; display: flex; align-items: center; gap: 7px; white-space: nowrap; border: 1px solid #d4dbe5; transition: transform .15s; }
...
.search-input  { width: 100%; padding: 9px 12px 9px 32px; border: 1.5px solid #d4dbe5; border-radius: 10px; font-size: 13px; font-family: 'Inter', sans-serif; outline: none; color: #444; background: #f9fafb; transition: border .15s; }
...
.btn-primary-pill { background: #12283a; color: white; padding: 10px 26px; border-radius: 25px; text-decoration: none; font-size: 13px; font-weight: 700; display: inline-flex; align-items: center; gap: 6px; }
...
.jenis-badge  { background: #eef3f9; color: #12283a; padding: 3px 10px; border-radius: 20px; font-size: 11px; font-weight: 700; white-space: nowrap; }
...
.btn-view   { background: #e0f7ff; color: #0d9488; border: none; padding: 5px 10px; border-radius: 8px; font-size: 11px; font-weight: 700; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; cursor: pointer; }
.btn-edit   { background: #eef3f9; color: #12283a; border: none; padding: 5px 10px; border-radius: 8px; font-size: 11px; font-weight: 700; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; cursor: pointer; }
...
.btn-edit:hover   { background: #dde8f0; }
...
.modal-box { background:white; border-radius:20px; padding:30px 28px; max-width:390px; width:90%; border: 1px solid #d4dbe5; text-align:center; animation:modalIn .2s ease; }
...
.page-btn.normal    { background: #eef3f9; color: #12283a; }
</style>
...
<div class="app-layout">
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-icon" style="background:#12283a;"><i class="fas fa-envelope"></i></div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:#fdbb11; font-weight:700; font-size:12px; white-space:nowrap;">{{ $s->nomor_surat ?: '—' }}</td>
                        ...
                        <td style="white-space:nowrap;">
                            <div style="font-size:12px; color:#555;">
                                <i class="fas fa-calendar" style="color:#fdbb11; margin-right:5px; font-size:10px;"></i>
