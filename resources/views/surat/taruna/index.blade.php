...
.btn-add:hover { transform:translateY(-2px); box-shadow:0 6px 20px rgba(0,0,0,.2); color:#4f46e5; }
...
.btn-view { background:#eef0ff; color:#4f46e5; border:none; padding:6px 14px; border-radius:20px; font-size:11px; font-weight:700; text-decoration:none; cursor:pointer; display:inline-flex; align-items:center; gap:5px; }
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span style="background:#eef0ff; color:#4f46e5; padding:3px 10px; border-radius:20px; font-size:11px; font-weight:700;">
                                {{ $s->jenis_surat }}
                            </span>
                        </td>
                        <td>
                        ...
                        <td style="font-size:12px; color:#666; white-space:nowrap;">
                            <i class="fas fa-calendar" style="color:#4f46e5; margin-right:5px;"></i>
